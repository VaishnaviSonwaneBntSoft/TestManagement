...
public class QuestionModel {
    ...
    @Pattern(regexp = "[1-4]", message = "Correct option must be between 1 and 4")
    @Column(name = "correct_option")
    private String correctOption;

    @NotNull(message = "Positive mark must not be null")
    @Pattern(regexp = "\\d+(\\.\\d{1,2})?", message = "Positive mark must be a numeric value with up to 2 decimal places")
    @Column(name = "positive_mark")
    private String positiveMark;

    @NotNull(message = "Negative mark must not be null")
    @Pattern(regexp = "\\d+(\\.\\d{1,2})?", message = "Negative mark must be a numeric value with up to 2 decimal places")
